...
pred.rf <- predict(mod.rf, newdata = train.ctr) # just to illustrate
tableAccuracy(train.ctr$jitter, pred.rf) #(.97 accuracy)
table('actual'=train.ctr$jitter, 'prediction'=pred.rf) #woah

# syntax is very similar to CART training
# Warning: this took about 15 mins on my computer
set.seed(99)
